...
(defn fig-start
  ...
  ;; :figwheel configurations are at the top level of your project.clj and are
  ;; not spread across different lein profiles
...
;; if you are in an nREPL environment you will need to make sure you have setup
;; piggieback for this to work
(defn cljs-repl
  "Launch a ClojureScript REPL that is connected to your build and host
  environment."
  []
  (f/cljs-repl))

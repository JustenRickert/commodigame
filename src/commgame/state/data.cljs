...
(def ^:private b-comm-before-id
  {"sand"
   {:price       0.25
    :processor-price 12.00}

   "sugar"
   {:price       0.50
    :processor-price 24.00}
